...
当前状态：`draft-ready`，暂不发布。版本化故障矩阵、4 个离线 fixture、保守诊断原型、GitHub 竞品预筛和完整 Skill 草案已完成；先完成当前 7 天自然观察窗口，再复核最新 ClawHub release 与 ClawHub 站内直接竞品，通过后才把草案移入正式 catalog。
...
1. `clawhub skill publish <path> --dry-run --owner <owner> --slug <stable-slug> --name "<Human Readable Name>"`
